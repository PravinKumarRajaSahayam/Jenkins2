<%@page import="com.hibernate.bean.Employee" %>
<%@page import="com.hibernate.dao.EmployeeDAO" %>
<%@page import="com.hibernate.EMSController" %>
...
<%-- JSTL Iterate code to iterate collection --%>
         ...
         <tr><td class='s' align='center'>${list.getId()}</td><td class='s' align='center'>${list.getName()}</td><td class='s' align='center'>${list.getDepartment()}</td><td class='s' align='center'>${lists.getVehicleNumber()}</td><td class='s' align='center'>${lists.getOwnerName()}</td></tr>
         </c:forEach>
         </table>         
</body>
</html>