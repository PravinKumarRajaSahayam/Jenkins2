...
<form class="row g-3 needs-validation" action="PerformInsert" method="post" novalidate id="s" name="assignmentForm" onsubmit="return validateForm();">
...
<div class="mb-3 row" id="a">
  ...
  <div class="col-sm-5" id="o" >
    <button class="btn btn-primary" type="submit" value="Insert Employee">Insert Employee</button>
    </div>
    </div>
</form>
</body>
